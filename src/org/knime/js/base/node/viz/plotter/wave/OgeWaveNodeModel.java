 ...
 */
final class OgeWaveNodeModel extends AbstractSVGWizardNodeModel<OgeWaveViewRepresentation,
        OgeWaveViewValue> implements LayoutTemplateProvider/*, CSSModifiable*/ {

    private static final NodeLogger LOGGER = NodeLogger.getLogger(OgeWaveNodeModel.class);

    private final OgeWaveViewConfig m_config;
     ...
     */
    OgeWaveNodeModel(final String viewName) {
        ...
        m_config = new OgeWaveViewConfig();
    }
    ...
    private ColumnRearranger createColumnAppender(final DataTableSpec spec, final List<String> selectionList) {
        ...
        if (newColName == null || newColName.trim().isEmpty()) {
            newColName = OgeWaveViewConfig.DEFAULT_SELECTION_COLUMN_NAME;
        }
     ...
     */
    @Override
    public OgeWaveViewRepresentation createEmptyViewRepresentation() {
        return new OgeWaveViewRepresentation();
    }
     ...
     */
    @Override
    public OgeWaveViewValue createEmptyViewValue() {
        return new OgeWaveViewValue();
    }
     ...
     */
    @Override
    public OgeWaveViewRepresentation getViewRepresentation() {
        OgeWaveViewRepresentation rep = super.getViewRepresentation();
    ...
    public String getJavascriptObjectID() {
        return "org.knime.js.base.node.viz.plotter.wave";
    }
    ...
    */
     ...
     */
    @Override
    public ValidationError validateViewValue(final OgeWaveViewValue viewContent) {
        synchronized (getLock()) {
    ...
    protected void performExecuteCreateView(final PortObject[] inData, final ExecutionContext exec) throws Exception {
        synchronized (getLock()) {
            ...
            OgeWaveViewRepresentation representation = getViewRepresentation();
    ...
    protected PortObject[] performExecuteCreatePortObjects(final PortObject svgImageFromView,
        ...
        synchronized (getLock()) {
            ...
            OgeWaveViewValue viewValue = getViewValue();
            if (m_config.getEnableSelection()) {
    ...
    private JSONKeyedValues2DDataset
        ...
        if (m_config.getMissingValueMethod().equals(OgeWaveViewConfig.MISSING_VALUE_METHOD_REMOVE_COLUMN) && missingValueColumns.length > 0 && getViewRepresentation().getReportOnMissingValues()) {
    ...
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        new OgeWaveViewConfig().loadSettings(settings);
    }
