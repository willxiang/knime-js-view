 ...
 */
public class OgeWaveNodeDialogPane extends NodeDialogPane {
    ...
    public OgeWaveNodeDialogPane() {
        ...
        m_dateTimeFormats = new DialogComponentDateTimeOptions(
            new SettingsModelDateTimeOptions(OgeWaveViewConfig.DATE_TIME_FORMATS), "Formatter");
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec[] specs)
        ...
        OgeWaveViewConfig config = new OgeWaveViewConfig();
    ...
    private void setMissingValueMethod(final String method) {
        switch (method) {
            case OgeWaveViewConfig.MISSING_VALUE_METHOD_GAP:
                m_missingValueMethodComboBox.setSelectedIndex(1);
                break;
            case OgeWaveViewConfig.MISSING_VALUE_METHOD_REMOVE_COLUMN:
                m_missingValueMethodComboBox.setSelectedIndex(2);
                break;
            case OgeWaveViewConfig.MISSING_VALUE_METHOD_NO_GAP:
            default:
    ...
    private String getMissingValueMethod() {
        switch (m_missingValueMethodComboBox.getSelectedIndex()) {
            case 0:
                return OgeWaveViewConfig.MISSING_VALUE_METHOD_NO_GAP;
            case 1:
                return OgeWaveViewConfig.MISSING_VALUE_METHOD_GAP;
            case 2:
                return OgeWaveViewConfig.MISSING_VALUE_METHOD_REMOVE_COLUMN;
        }
        return null;
    }
}
