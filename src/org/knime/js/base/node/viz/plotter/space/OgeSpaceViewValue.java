...
public class OgeSpaceViewValue extends JSONViewContent {
    ...
    public void saveToNodeSettings(final NodeSettingsWO settings) {
        settings.addString(OgeSpaceViewConfig.CHART_TITLE, getChartTitle());
        settings.addString(OgeSpaceViewConfig.CHART_SUBTITLE, getChartSubtitle());
        settings.addString(OgeSpaceViewConfig.X_COL, getxColumn());
        settings.addStringArray(OgeSpaceViewConfig.Y_COLS, getyColumns());
        settings.addString(OgeSpaceViewConfig.X_AXIS_LABEL, getxAxisLabel());
        settings.addString(OgeSpaceViewConfig.Y_AXIS_LABEL, getyAxisLabel());
        settings.addString(OgeSpaceViewConfig.X_AXIS_MIN, getxAxisMin() == null ? null : getxAxisMin().toString());
        settings.addString(OgeSpaceViewConfig.X_AXIS_MAX, getxAxisMax() == null ? null : getxAxisMax().toString());
        settings.addString(OgeSpaceViewConfig.Y_AXIS_MIN, getyAxisMin() == null ? null : getyAxisMin().toString());
        settings.addString(OgeSpaceViewConfig.Y_AXIS_MAX, getyAxisMax() == null ? null : getyAxisMax().toString());
        settings.addString(OgeSpaceViewConfig.DOT_SIZE, getDotSize() == null ? null : getDotSize().toString());
        settings.addStringArray(OgeSpaceViewValue.SELECTED_KEYS, m_selection);
        settings.addString(OgeSpaceViewValue.IMAGE, getImage());
    }
    ...
    public void loadFromNodeSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        setChartTitle(settings.getString(OgeSpaceViewConfig.CHART_TITLE));
        setChartSubtitle(settings.getString(OgeSpaceViewConfig.CHART_SUBTITLE));
        setxColumn(settings.getString(OgeSpaceViewConfig.X_COL));
        setyColumns(settings.getStringArray(OgeSpaceViewConfig.Y_COLS));
        setxAxisLabel(settings.getString(OgeSpaceViewConfig.X_AXIS_LABEL));
        setyAxisLabel(settings.getString(OgeSpaceViewConfig.Y_AXIS_LABEL));
        String xMin = settings.getString(OgeSpaceViewConfig.X_AXIS_MIN);
        String xMax = settings.getString(OgeSpaceViewConfig.X_AXIS_MAX);
        String yMin = settings.getString(OgeSpaceViewConfig.Y_AXIS_MIN);
        String yMax = settings.getString(OgeSpaceViewConfig.Y_AXIS_MAX);
        String dotSize = settings.getString(OgeSpaceViewConfig.DOT_SIZE);
        ...
        setSelection(settings.getStringArray(OgeSpaceViewValue.SELECTED_KEYS));
        setImage(settings.getString(OgeSpaceViewValue.IMAGE));
    }
    ...
    public boolean equals(final Object obj) {
        ...
        OgeSpaceViewValue other = (OgeSpaceViewValue)obj;
