...
import org.knime.js.base.node.viz.plotter.wave.OgeWaveViewConfig;
...
final class ScatterPlotViewConfig {
    ...
    public String getBackgroundColorString() {
        return OgeWaveViewConfig.getRGBAStringFromColor(m_backgroundColor);
    }
    ...
    public String getDataAreaColorString() {
        return OgeWaveViewConfig.getRGBAStringFromColor(m_dataAreaColor);
    }
    ...
    public String getGridColorString() {
        return OgeWaveViewConfig.getRGBAStringFromColor(m_gridColor);
    }
   ...
   /**
    ...
    public void loadSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        setBackgroundColor(OgeWaveViewConfig.getColorFromString(bgColorString));
        String dataColorString = settings.getString(DATA_AREA_COLOR);
        setDataAreaColor(OgeWaveViewConfig.getColorFromString(dataColorString));
        String gridColorString = settings.getString(GRID_COLOR);
        setGridColor(OgeWaveViewConfig.getColorFromString(gridColorString));
    ...
    public void loadSettingsForDialog(final NodeSettingsRO settings) {
        ...
        try {
            backgroundColor = OgeWaveViewConfig.getColorFromString(bgColorString);
        ...
        try {
            dataAreaColor = OgeWaveViewConfig.getColorFromString(dataColorString);
        } catch (InvalidSettingsException e) { /* do nothing */ }
        ...
        try {
            gridColor = OgeWaveViewConfig.getColorFromString(gridColorString);
        } catch (InvalidSettingsException e) { /* do nothing */ }
