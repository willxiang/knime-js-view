...
public class OgeSpaceViewRepresentation extends JSONViewContent {
    ...
    public void saveToNodeSettings(final NodeSettingsWO settings) {
        settings.addBoolean(OgeSpaceViewConfig.SHOW_LEGEND, getShowLegend());
        settings.addBoolean(OgeSpaceViewConfig.AUTO_RANGE_AXES, getAutoRangeAxes());
        settings.addBoolean(OgeSpaceViewConfig.USE_DOMAIN_INFO, getUseDomainInformation());
        settings.addBoolean(OgeSpaceViewConfig.SHOW_GRID, getShowGrid());
        settings.addBoolean(OgeSpaceViewConfig.SHOW_CROSSHAIR, getShowCrosshair());
        settings.addBoolean(OgeSpaceViewConfig.SNAP_TO_POINTS, getSnapToPoints());
        settings.addBoolean(OgeSpaceViewConfig.RESIZE_TO_WINDOW, getResizeToWindow());

        settings.addBoolean(OgeSpaceViewConfig.ENABLE_CONFIG, getEnableViewConfiguration());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_TTILE_CHANGE, getEnableTitleChange());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_SUBTTILE_CHANGE, getEnableSubtitleChange());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_X_COL_CHANGE, getEnableXColumnChange());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_Y_COL_CHANGE, getEnableYColumnChange());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_X_LABEL_EDIT, getEnableXAxisLabelEdit());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_Y_LABEL_EDIT, getEnableYAxisLabelEdit());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_DOT_SIZE_CHANGE, getEnableDotSizeChange());

        settings.addBoolean(OgeSpaceViewConfig.ENABLE_PANNING, getEnablePanning());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_ZOOMING, getEnableZooming());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_DRAG_ZOOMING, getEnableDragZooming());
        settings.addBoolean(OgeSpaceViewConfig.SHOW_ZOOM_RESET_BUTTON, getShowZoomResetButton());

        settings.addBoolean(OgeSpaceViewConfig.ENABLE_SELECTION, getEnableSelection());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_RECTANGLE_SELECTION, getEnableRectangleSelection());
        settings.addBoolean(OgeSpaceViewConfig.ENABLE_LASSO_SELECTION, getEnableLassoSelection());

        settings.addInt(OgeSpaceViewConfig.IMAGE_WIDTH, getImageWidth());
        settings.addInt(OgeSpaceViewConfig.IMAGE_HEIGHT, getImageHeight());
        settings.addString(OgeSpaceViewConfig.BACKGROUND_COLOR, getBackgroundColor());
        settings.addString(OgeSpaceViewConfig.DATA_AREA_COLOR, getDataAreaColor());
        settings.addString(OgeSpaceViewConfig.GRID_COLOR, getGridColor());
        ...
        // added with 3.3
        settings.addBoolean(OgeSpaceViewConfig.CFG_DISPLAY_FULLSCREEN_BUTTON, getDisplayFullscreenButton());

        // added with 3.4
        settings.addString(OgeSpaceViewConfig.MISSING_VALUE_METHOD, getMissingValueMethod());
        settings.addBoolean(OgeSpaceViewConfig.SHOW_WARNING_IN_VIEW, getShowWarningInView());
        m_warnings.saveToNodeSettings(settings);
        settings.addBoolean(OgeSpaceViewConfig.REPORT_ON_MISSING_VALUES, getReportOnMissingValues());

        m_dateTimeFormats.saveToNodeSettings(settings.addNodeSettings(OgeSpaceViewConfig.DATE_TIME_FORMATS));
    }
    ...
    public void loadFromNodeSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        setShowLegend(settings.getBoolean(OgeSpaceViewConfig.SHOW_LEGEND));
        setAutoRangeAxes(settings.getBoolean(OgeSpaceViewConfig.AUTO_RANGE_AXES));
        setUseDomainInformation(settings.getBoolean(OgeSpaceViewConfig.USE_DOMAIN_INFO));
        setShowGrid(settings.getBoolean(OgeSpaceViewConfig.SHOW_GRID));
        setShowCrosshair(settings.getBoolean(OgeSpaceViewConfig.SHOW_CROSSHAIR));
        setSnapToPoints(settings.getBoolean(OgeSpaceViewConfig.SNAP_TO_POINTS));
        setResizeToWindow(settings.getBoolean(OgeSpaceViewConfig.RESIZE_TO_WINDOW));

        setEnableViewConfiguration(settings.getBoolean(OgeSpaceViewConfig.ENABLE_CONFIG));
        setEnableTitleChange(settings.getBoolean(OgeSpaceViewConfig.ENABLE_TTILE_CHANGE));
        setEnableSubtitleChange(settings.getBoolean(OgeSpaceViewConfig.ENABLE_SUBTTILE_CHANGE));
        setEnableXColumnChange(settings.getBoolean(OgeSpaceViewConfig.ENABLE_X_COL_CHANGE));
        setEnableYColumnChange(settings.getBoolean(OgeSpaceViewConfig.ENABLE_Y_COL_CHANGE));
        setEnableXAxisLabelEdit(settings.getBoolean(OgeSpaceViewConfig.ENABLE_X_LABEL_EDIT));
        setEnableYAxisLabelEdit(settings.getBoolean(OgeSpaceViewConfig.ENABLE_Y_LABEL_EDIT));
        setEnableDotSizeChange(settings.getBoolean(OgeSpaceViewConfig.ENABLE_DOT_SIZE_CHANGE));

        setEnablePanning(settings.getBoolean(OgeSpaceViewConfig.ENABLE_PANNING));
        setEnableZooming(settings.getBoolean(OgeSpaceViewConfig.ENABLE_ZOOMING));
        setEnableDragZooming(settings.getBoolean(OgeSpaceViewConfig.ENABLE_DRAG_ZOOMING));
        setShowZoomResetButton(settings.getBoolean(OgeSpaceViewConfig.SHOW_ZOOM_RESET_BUTTON));

        setEnableSelection(settings.getBoolean(OgeSpaceViewConfig.ENABLE_SELECTION));
        setEnableRectangleSelection(settings.getBoolean(OgeSpaceViewConfig.ENABLE_RECTANGLE_SELECTION));
        setEnableLassoSelection(settings.getBoolean(OgeSpaceViewConfig.ENABLE_LASSO_SELECTION));

        setImageWidth(settings.getInt(OgeSpaceViewConfig.IMAGE_WIDTH));
        setImageHeight(settings.getInt(OgeSpaceViewConfig.IMAGE_HEIGHT));
        setBackgroundColor(settings.getString(OgeSpaceViewConfig.BACKGROUND_COLOR));
        setDataAreaColor(settings.getString(OgeSpaceViewConfig.DATA_AREA_COLOR));
        setGridColor(settings.getString(OgeSpaceViewConfig.GRID_COLOR));
        ...
        // added with 3.3
        setDisplayFullscreenButton(settings.getBoolean(OgeSpaceViewConfig.CFG_DISPLAY_FULLSCREEN_BUTTON, OgeSpaceViewConfig.DEFAULT_DISPLAY_FULLSCREEN_BUTTON));

        // added with 3.4
        setMissingValueMethod(settings.getString(OgeSpaceViewConfig.MISSING_VALUE_METHOD, OgeSpaceViewConfig.MISSING_VALUE_METHOD_DEFAULT));
        setShowWarningInView(settings.getBoolean(OgeSpaceViewConfig.SHOW_WARNING_IN_VIEW, OgeSpaceViewConfig.DEFAULT_SHOW_WARNING_IN_VIEW));
        m_warnings.loadFromNodeSettings(settings);
        setReportOnMissingValues(settings.getBoolean(OgeSpaceViewConfig.REPORT_ON_MISSING_VALUES, OgeSpaceViewConfig.DEFAULT_REPORT_ON_MISSING_VALUES));

        // added with 3.5
        if (settings.containsKey(OgeSpaceViewConfig.DATE_TIME_FORMATS)) {
            m_dateTimeFormats = JSONDateTimeOptions.loadFromNodeSettings(settings.getNodeSettings(OgeSpaceViewConfig.DATE_TIME_FORMATS));
        } else {
            // convert from legacy
            String legacyDateTimeFormat = settings.getString(OgeSpaceViewConfig.DATE_FORMAT);
            String newDateTimeFormat = ConversionDateTimeFormat.oldToNew(legacyDateTimeFormat);
            SettingsModelDateTimeOptions dateTimeOptions = new SettingsModelDateTimeOptions(OgeSpaceViewConfig.DATE_TIME_FORMATS);
    ...
    public boolean equals(final Object obj) {
        ...
        OgeSpaceViewRepresentation other = (OgeSpaceViewRepresentation)obj;
