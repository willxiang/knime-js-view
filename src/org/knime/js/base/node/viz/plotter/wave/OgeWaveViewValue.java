...
public class OgeWaveViewValue extends JSONViewContent {
    ...
    public void saveToNodeSettings(final NodeSettingsWO settings) {
        settings.addString(OgeWaveViewConfig.CHART_TITLE, getChartTitle());
        settings.addString(OgeWaveViewConfig.CHART_SUBTITLE, getChartSubtitle());
        settings.addString(OgeWaveViewConfig.X_COL, getxColumn());
        settings.addStringArray(OgeWaveViewConfig.Y_COLS, getyColumns());
        settings.addString(OgeWaveViewConfig.X_AXIS_LABEL, getxAxisLabel());
        settings.addString(OgeWaveViewConfig.Y_AXIS_LABEL, getyAxisLabel());
        settings.addString(OgeWaveViewConfig.X_AXIS_MIN, getxAxisMin() == null ? null : getxAxisMin().toString());
        settings.addString(OgeWaveViewConfig.X_AXIS_MAX, getxAxisMax() == null ? null : getxAxisMax().toString());
        settings.addString(OgeWaveViewConfig.Y_AXIS_MIN, getyAxisMin() == null ? null : getyAxisMin().toString());
        settings.addString(OgeWaveViewConfig.Y_AXIS_MAX, getyAxisMax() == null ? null : getyAxisMax().toString());
        settings.addString(OgeWaveViewConfig.DOT_SIZE, getDotSize() == null ? null : getDotSize().toString());
        settings.addStringArray(OgeWaveViewValue.SELECTED_KEYS, m_selection);
        settings.addString(OgeWaveViewValue.IMAGE, getImage());
    }
    ...
    public void loadFromNodeSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        setChartTitle(settings.getString(OgeWaveViewConfig.CHART_TITLE));
        setChartSubtitle(settings.getString(OgeWaveViewConfig.CHART_SUBTITLE));
        setxColumn(settings.getString(OgeWaveViewConfig.X_COL));
        setyColumns(settings.getStringArray(OgeWaveViewConfig.Y_COLS));
        setxAxisLabel(settings.getString(OgeWaveViewConfig.X_AXIS_LABEL));
        setyAxisLabel(settings.getString(OgeWaveViewConfig.Y_AXIS_LABEL));
        String xMin = settings.getString(OgeWaveViewConfig.X_AXIS_MIN);
        String xMax = settings.getString(OgeWaveViewConfig.X_AXIS_MAX);
        String yMin = settings.getString(OgeWaveViewConfig.Y_AXIS_MIN);
        String yMax = settings.getString(OgeWaveViewConfig.Y_AXIS_MAX);
        String dotSize = settings.getString(OgeWaveViewConfig.DOT_SIZE);
        ...
        setSelection(settings.getStringArray(OgeWaveViewValue.SELECTED_KEYS));
        setImage(settings.getString(OgeWaveViewValue.IMAGE));
    }
    ...
    public boolean equals(final Object obj) {
        ...
        OgeWaveViewValue other = (OgeWaveViewValue)obj;
