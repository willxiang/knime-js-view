 ...
 */
package org.knime.js.base.node.viz.plotter.wave;
...
public class OgeWaveViewRepresentation extends JSONViewContent {
    ...
    public void saveToNodeSettings(final NodeSettingsWO settings) {
        settings.addBoolean(OgeWaveViewConfig.SHOW_LEGEND, getShowLegend());
        settings.addBoolean(OgeWaveViewConfig.AUTO_RANGE_AXES, getAutoRangeAxes());
        settings.addBoolean(OgeWaveViewConfig.USE_DOMAIN_INFO, getUseDomainInformation());
        settings.addBoolean(OgeWaveViewConfig.SHOW_GRID, getShowGrid());
        settings.addBoolean(OgeWaveViewConfig.SHOW_CROSSHAIR, getShowCrosshair());
        settings.addBoolean(OgeWaveViewConfig.SNAP_TO_POINTS, getSnapToPoints());
        settings.addBoolean(OgeWaveViewConfig.RESIZE_TO_WINDOW, getResizeToWindow());

        settings.addBoolean(OgeWaveViewConfig.ENABLE_CONFIG, getEnableViewConfiguration());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_TTILE_CHANGE, getEnableTitleChange());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_SUBTTILE_CHANGE, getEnableSubtitleChange());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_X_COL_CHANGE, getEnableXColumnChange());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_Y_COL_CHANGE, getEnableYColumnChange());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_X_LABEL_EDIT, getEnableXAxisLabelEdit());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_Y_LABEL_EDIT, getEnableYAxisLabelEdit());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_DOT_SIZE_CHANGE, getEnableDotSizeChange());

        settings.addBoolean(OgeWaveViewConfig.ENABLE_PANNING, getEnablePanning());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_ZOOMING, getEnableZooming());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_DRAG_ZOOMING, getEnableDragZooming());
        settings.addBoolean(OgeWaveViewConfig.SHOW_ZOOM_RESET_BUTTON, getShowZoomResetButton());

        settings.addBoolean(OgeWaveViewConfig.ENABLE_SELECTION, getEnableSelection());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_RECTANGLE_SELECTION, getEnableRectangleSelection());
        settings.addBoolean(OgeWaveViewConfig.ENABLE_LASSO_SELECTION, getEnableLassoSelection());

        settings.addInt(OgeWaveViewConfig.IMAGE_WIDTH, getImageWidth());
        settings.addInt(OgeWaveViewConfig.IMAGE_HEIGHT, getImageHeight());
        settings.addString(OgeWaveViewConfig.BACKGROUND_COLOR, getBackgroundColor());
        settings.addString(OgeWaveViewConfig.DATA_AREA_COLOR, getDataAreaColor());
        settings.addString(OgeWaveViewConfig.GRID_COLOR, getGridColor());
        ...
        // added with 3.3
        settings.addBoolean(OgeWaveViewConfig.CFG_DISPLAY_FULLSCREEN_BUTTON, getDisplayFullscreenButton());

        // added with 3.4
        settings.addString(OgeWaveViewConfig.MISSING_VALUE_METHOD, getMissingValueMethod());
        settings.addBoolean(OgeWaveViewConfig.SHOW_WARNING_IN_VIEW, getShowWarningInView());
        m_warnings.saveToNodeSettings(settings);
        settings.addBoolean(OgeWaveViewConfig.REPORT_ON_MISSING_VALUES, getReportOnMissingValues());

        m_dateTimeFormats.saveToNodeSettings(settings.addNodeSettings(OgeWaveViewConfig.DATE_TIME_FORMATS));
    }
    ...
    public void loadFromNodeSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        setShowLegend(settings.getBoolean(OgeWaveViewConfig.SHOW_LEGEND));
        setAutoRangeAxes(settings.getBoolean(OgeWaveViewConfig.AUTO_RANGE_AXES));
        setUseDomainInformation(settings.getBoolean(OgeWaveViewConfig.USE_DOMAIN_INFO));
        setShowGrid(settings.getBoolean(OgeWaveViewConfig.SHOW_GRID));
        setShowCrosshair(settings.getBoolean(OgeWaveViewConfig.SHOW_CROSSHAIR));
        setSnapToPoints(settings.getBoolean(OgeWaveViewConfig.SNAP_TO_POINTS));
        setResizeToWindow(settings.getBoolean(OgeWaveViewConfig.RESIZE_TO_WINDOW));

        setEnableViewConfiguration(settings.getBoolean(OgeWaveViewConfig.ENABLE_CONFIG));
        setEnableTitleChange(settings.getBoolean(OgeWaveViewConfig.ENABLE_TTILE_CHANGE));
        setEnableSubtitleChange(settings.getBoolean(OgeWaveViewConfig.ENABLE_SUBTTILE_CHANGE));
        setEnableXColumnChange(settings.getBoolean(OgeWaveViewConfig.ENABLE_X_COL_CHANGE));
        setEnableYColumnChange(settings.getBoolean(OgeWaveViewConfig.ENABLE_Y_COL_CHANGE));
        setEnableXAxisLabelEdit(settings.getBoolean(OgeWaveViewConfig.ENABLE_X_LABEL_EDIT));
        setEnableYAxisLabelEdit(settings.getBoolean(OgeWaveViewConfig.ENABLE_Y_LABEL_EDIT));
        setEnableDotSizeChange(settings.getBoolean(OgeWaveViewConfig.ENABLE_DOT_SIZE_CHANGE));

        setEnablePanning(settings.getBoolean(OgeWaveViewConfig.ENABLE_PANNING));
        setEnableZooming(settings.getBoolean(OgeWaveViewConfig.ENABLE_ZOOMING));
        setEnableDragZooming(settings.getBoolean(OgeWaveViewConfig.ENABLE_DRAG_ZOOMING));
        setShowZoomResetButton(settings.getBoolean(OgeWaveViewConfig.SHOW_ZOOM_RESET_BUTTON));

        setEnableSelection(settings.getBoolean(OgeWaveViewConfig.ENABLE_SELECTION));
        setEnableRectangleSelection(settings.getBoolean(OgeWaveViewConfig.ENABLE_RECTANGLE_SELECTION));
        setEnableLassoSelection(settings.getBoolean(OgeWaveViewConfig.ENABLE_LASSO_SELECTION));

        setImageWidth(settings.getInt(OgeWaveViewConfig.IMAGE_WIDTH));
        setImageHeight(settings.getInt(OgeWaveViewConfig.IMAGE_HEIGHT));
        setBackgroundColor(settings.getString(OgeWaveViewConfig.BACKGROUND_COLOR));
        setDataAreaColor(settings.getString(OgeWaveViewConfig.DATA_AREA_COLOR));
        setGridColor(settings.getString(OgeWaveViewConfig.GRID_COLOR));
        ...
        // added with 3.3
        setDisplayFullscreenButton(settings.getBoolean(OgeWaveViewConfig.CFG_DISPLAY_FULLSCREEN_BUTTON, OgeWaveViewConfig.DEFAULT_DISPLAY_FULLSCREEN_BUTTON));

        // added with 3.4
        setMissingValueMethod(settings.getString(OgeWaveViewConfig.MISSING_VALUE_METHOD, OgeWaveViewConfig.MISSING_VALUE_METHOD_DEFAULT));
        setShowWarningInView(settings.getBoolean(OgeWaveViewConfig.SHOW_WARNING_IN_VIEW, OgeWaveViewConfig.DEFAULT_SHOW_WARNING_IN_VIEW));
        m_warnings.loadFromNodeSettings(settings);
        setReportOnMissingValues(settings.getBoolean(OgeWaveViewConfig.REPORT_ON_MISSING_VALUES, OgeWaveViewConfig.DEFAULT_REPORT_ON_MISSING_VALUES));

        // added with 3.5
        if (settings.containsKey(OgeWaveViewConfig.DATE_TIME_FORMATS)) {
            m_dateTimeFormats = JSONDateTimeOptions.loadFromNodeSettings(settings.getNodeSettings(OgeWaveViewConfig.DATE_TIME_FORMATS));
        } else {
            // convert from legacy
            String legacyDateTimeFormat = settings.getString(OgeWaveViewConfig.DATE_FORMAT);
            String newDateTimeFormat = ConversionDateTimeFormat.oldToNew(legacyDateTimeFormat);
            SettingsModelDateTimeOptions dateTimeOptions = new SettingsModelDateTimeOptions(OgeWaveViewConfig.DATE_TIME_FORMATS);
    ...
    public boolean equals(final Object obj) {
        ...
        OgeWaveViewRepresentation other = (OgeWaveViewRepresentation)obj;
