 ...
 */
public class OgeSpaceNodeDialogPane extends NodeDialogPane {
    ...
    public OgeSpaceNodeDialogPane() {
        ...
        m_dateTimeFormats = new DialogComponentDateTimeOptions(
            new SettingsModelDateTimeOptions(OgeSpaceViewConfig.DATE_TIME_FORMATS), "Formatter");
    ...
    protected void loadSettingsFrom(final NodeSettingsRO settings, final DataTableSpec[] specs)
        ...
        OgeSpaceViewConfig config = new OgeSpaceViewConfig();
    ...
    private void setMissingValueMethod(final String method) {
        switch (method) {
            case OgeSpaceViewConfig.MISSING_VALUE_METHOD_GAP:
                m_missingValueMethodComboBox.setSelectedIndex(1);
                break;
            case OgeSpaceViewConfig.MISSING_VALUE_METHOD_REMOVE_COLUMN:
                m_missingValueMethodComboBox.setSelectedIndex(2);
                break;
            case OgeSpaceViewConfig.MISSING_VALUE_METHOD_NO_GAP:
            default:
    ...
    private String getMissingValueMethod() {
        switch (m_missingValueMethodComboBox.getSelectedIndex()) {
            case 0:
                return OgeSpaceViewConfig.MISSING_VALUE_METHOD_NO_GAP;
            case 1:
                return OgeSpaceViewConfig.MISSING_VALUE_METHOD_GAP;
            case 2:
                return OgeSpaceViewConfig.MISSING_VALUE_METHOD_REMOVE_COLUMN;
        }
        return null;
    }
}
